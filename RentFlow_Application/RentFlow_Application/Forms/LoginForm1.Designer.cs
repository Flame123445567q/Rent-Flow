namespace RentFlow_Application.Forms
{
    partial class LoginForm
    {
        ...
        {
            panelLeft = new Panel();
            lblAboutRentFlow = new Label();
            btnCreateAnAccount = new Button();
            panel4 = new Panel();
            lblOr = new Label();
            panel3 = new Panel();
            chkRemberMe = new CheckBox();
            linkForgotPassword = new LinkLabel();
            btnSigningIn = new Button();
            ...
            btnLandLord = new Button();
            panelSS = new Panel();
            lblManageproperties = new Label();
            lblWelcomeBack = new Label();
            smallLeftPanel = new Panel();
            panelLogo = new Panel();
            lblBuldingIcon = new Label();
            ...
            panelLeft.Controls.Add(lblAboutRentFlow);
            panelLeft.Controls.Add(btnCreateAnAccount);
            panelLeft.Controls.Add(panel4);
            panelLeft.Controls.Add(lblOr);
            panelLeft.Controls.Add(panel3);
            panelLeft.Controls.Add(chkRemberMe);
            panelLeft.Controls.Add(linkForgotPassword);
            panelLeft.Controls.Add(btnSigningIn);
            panelLeft.Controls.Add(panelPassword);
            ...
            panelLeft.Controls.Add(panelSS);
            panelLeft.Controls.Add(smallLeftPanel);
            ...
            // btnCreateAnAccount
            // 
            btnCreateAnAccount.BackColor = Color.White;
            ...
            // linkForgotPassword
            // 
            linkForgotPassword.ActiveLinkColor = Color.FromArgb(0, 91, 219);
            ...
            linkForgotPassword.LinkColor = Color.FromArgb(0, 91, 219);
            linkForgotPassword.Location = new Point(181, 410);
            linkForgotPassword.Margin = new Padding(2, 0, 2, 0);
            linkForgotPassword.Name = "linkForgotPassword";
            linkForgotPassword.Size = new Size(127, 20);
            linkForgotPassword.TabIndex = 10;
            linkForgotPassword.TabStop = true;
            linkForgotPassword.Text = "Forgot password?";
            linkForgotPassword.VisitedLinkColor = Color.FromArgb(0, 91, 219);
            linkForgotPassword.LinkClicked += linkForgotPassword_LinkClicked;
            // 
            // btnSigningIn
            // 
            btnSigningIn.BackColor = Color.FromArgb(37, 99, 235);
            ...
            panelSS.Controls.Add(roundedPanel2);
            ...
            // smallLeftPanel
            // 
            smallLeftPanel.Controls.Add(panelLogo);
            smallLeftPanel.Controls.Add(lblPropertyManagementSystem);
            ...
            // lblBuldingIcon
            // 
            lblBuldingIcon.BackColor = Color.Transparent;
            ...
            // panelRight
            // 
            panelRight.BackColor = Color.FromArgb(37, 99, 235);
            ...
            // lblAnotherBuilding
            // 
            lblAnotherBuilding.AutoSize = true;
            ...
            roundedPanel1.Location = new Point(0, 3);
            roundedPanel1.Name = "roundedPanel1";
            roundedPanel1.Size = new Size(322, 88);
            roundedPanel1.TabIndex = 4;
            // 
            // roundedPanel2
            // 
            roundedPanel2.BackColor = Color.White;
            roundedPanel2.Controls.Add(lblManageproperties);
            roundedPanel2.Location = new Point(0, -127);
            roundedPanel2.Name = "roundedPanel2";
            roundedPanel2.Size = new Size(322, 777);
            ...
            smallLeftPanel.ResumeLayout(false);
            smallLeftPanel.PerformLayout();
        ...
        private Panel smallLeftPanel;
        private Label lblPropertyManagementSystem;
        private Label lblRentFlow;
        private Panel panel1;
        private Button btnAdmin;
        private Button btnTenant;
        private Button btnLandLord;
        private Panel panelSS;
        private Label lblManageproperties;
        ...
        private Label lblBuldingIcon;
        private Button btnSigningIn;
        private LinkLabel linkForgotPassword;
        private CheckBox chkRemberMe;
        private Panel panel3;
        private Label lblOr;
        private Button btnCreateAnAccount;
        private Panel panel4;
        private Label lblAboutRentFlow;
        private Label lblBigBuilding;
        private Label lblAnotherBuilding;
        private Label lblTextManage;
        private Label lblTextSmart;
